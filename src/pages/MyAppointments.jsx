        ...
        {appointments.map((item, index) => (
          ...
          >
            ...
            <div className="flex-1 text-sm text-[#5E5E5E]">
              ...
              <p className="">{item.docData.address.city}</p>
              <p className="">{item.docData.address.street}</p>
              <p className="">{item.docData.address.building}</p>
              <p className=" mt-1">
                ...
                <span>
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <span className="text-green-400">{item.slotTime}</span>
                </span>
              </p>
            </div>
            <div></div>
